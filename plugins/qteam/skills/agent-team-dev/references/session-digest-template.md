...
Parallel group:
Agent:
Derived execution tier:
Work kind / risk flags:
Branch and commits:
Status:
...
TDD seam RED/GREEN evidence:
Diagnosis feedback/root cause evidence:
Verification result:
Validation scope:
Claim boundary:
Typed handoff / successor:
Open decision gates:
...
Review gates:
Review intensity / risk flags:
Findings fixed:
Verification result:
Validation scope:
Claim boundary:
Blocking handoffs / successors:
