...
`migrate-run` handles unfinished schema-version-2/3/4/5 runs and schema-version-6
runs with legacy policy-v2/additive/core-layer identity. It rejects finished,
publication-sealed, or actively executing runs. Every unfinished migrated task must be
